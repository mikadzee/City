<template>
  <section class="popular-attractions ubuntu-regular">
    ...
    <div class="list-attractions">
      <div class="attraction" v-for="attraction in popularAttractions" @click="openPageDitail(attraction)">
...
<script setup>
  ...
  let popularAttractions = ref([
    ...
    { id: 4, img: img5, title: "Музей истории Норильска", description: "Пожалуй, самое популярное место для ознакомления с историей города, его промышленным развитием и сложной судьбой.", mouseenterr: false},
    { id: 5, img: img6, title: "Норильская мечеть «Нурд–Камал»", description: " Она внесена в Книгу рекордов Гиннесса как самая северная мечеть в мире.", mouseenterr: false},
    ]);
  ...
  function openPageDitail (card) {
    console.log(card);
    navigateTo({
      path: `/cardAttractions/${card.id}`,
